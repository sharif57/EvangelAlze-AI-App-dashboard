...
export default function VerifyEmail() {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen bg-white">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center bg-[#E8EDEE] p-4">
        <div className="w-full max-w-md p-6 bg-white rounded-lg shadow-sm">
          ...
          <button
            ...
            className="w-full py-3 bg-[#004E64] hover:bg-red-600 text-white font-semibold rounded-full transition duration-200"
          >
            Verify
          </button>
